...
const translations = {
  uk: {
    ...
    auth: {
      ...
      loginSubtitle: 'Введіть свої дані для входу',
    ...
    dashboard: {
      welcome: 'Вітаємо',
      subtitle: 'Керуйте своїми підписками',
      activeSubscriptions: 'Активні підписки',
      monthlySpending: 'Щомісячні витрати',
      upcomingRenewals: 'Потрібно продовжити',
      currency: 'грн',
      notifications: 'Сповіщення',
      expiringNotification: 'Ваша підписка на',
      expiringIn: 'закінчується через',
      viewDetails: 'Переглянути',
      mySubscriptions: 'Мої підписки',
      mySubscriptionsDesc: 'Переглянути та керувати підписками',
      paymentHistory: 'Історія платежів',
      paymentHistoryDesc: 'Переглянути всі транзакції',
      settings: 'Налаштування',
      settingsDesc: 'Керувати профілем та налаштуваннями',
      day: 'день',
      days2to4: 'дні',
      days: 'днів'
    },
    subscriptions: {
      title: 'Мої підписки',
      subtitle: 'Керуйте всіма своїми підписками',
      filterAll: 'Всі',
      filterActive: 'Активні',
      filterExpired: 'Закінчені',
      noSubscriptions: 'У вас поки немає підписок',
      noSubscriptionsDesc: 'Перегляньте наші послуги та оберіть підходящий варіант',
      ...
      renewButton: 'Продовжити',
      reactivateButton: 'Поновити',
      planIndividual: 'Індивідуальний',
      planFamily: 'Сімейний',
      planStudent: 'Студентський',
      planStandard: 'Стандартний',
      planPremium: 'Преміум',
      statusActive: 'Активна',
      statusExpiring: 'Закінчується',
      statusExpired: 'Закінчилась'
    },
    payment: {
      title: 'Оплата підписки',
      selectDuration: 'Оберіть термін',
      month: 'місяць',
      months: 'місяців',
      save: 'Заощадьте',
      ...
      discount: 'Знижка',
      total: 'До сплати',
      confirm: 'Підтвердити оплату',
      cancel: 'Скасувати',
      processing: 'Обробка...',
      successTitle: 'Оплата успішна!',
      successMessage: 'Ваша підписка успішно продовжена',
      service: 'Послуга',
      amount: 'Сума',
      close: 'Закрити'
    },
    payments: {
      ...
      subtitle: 'Всі ваші транзакції',
      noPayments: 'Немає платежів',
      noPaymentsDesc: 'Ваші платежі з\'являться тут після оплати',
      date: 'Дата',
      service: 'Послуга',
    ...
    settings: {
      title: 'Налаштування',
      subtitle: 'Керуйте своїм профілем',
      ...
      emailNotificationsDesc: 'Отримувати сповіщення на email',
      renewalReminders: 'Нагадування про продовження',
      renewalRemindersDesc: 'Нагадувати про підписки, що закінчуються',
      promotions: 'Акції та пропозиції',
      promotionsDesc: 'Отримувати спеціальні пропозиції',
      dangerZone: 'Зона ризику',
      dangerZoneDesc: 'Після виходу ви можете увійти знову в будь-який час',
